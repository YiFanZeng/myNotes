...
#repo --name=base    --baseurl=http://192.168.0.237/Cerf/ctvm/
repo --name=base    --baseurl=http://192.168.0.237/Cerf/ctvm/
...
sed -i -e 's/HOSTNAME=localhost.localdomain/HOSTNAME=cloudtimes.com/g' /etc/sysconfig/network
/bin/hostname cloudtimes.com
